...
export function renderVideoAccessEmail({
  ...
  const subject = `Ihr Zugang zum Videokurs: ${courseTitle}`;
    ...
    bodyHtml: `
      ...
      <div style="margin: 20px 0; padding: 12px; background-color: #fef3c7; border-left: 4px solid #f59e0b; border-radius: 4px;">
        <p style="margin: 0; color: #92400e; font-size: 14px; line-height: 1.6;">
          <strong>Hinweis:</strong> Dieser Link ist gültig bis zum <strong>${expiresFormatted}</strong>. Bitte speichern Sie diesen Link, um später darauf zuzugreifen.
        </p>
      </div>
